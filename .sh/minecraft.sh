...
function minecraft {
    ...
    if [[ "$1" == "" ]]; then
        ...
        TargetPath="$MCPATH/bin/MinecraftLauncher.jar"
        BinaryURL="https://s3.amazonaws.com/MinecraftDownload/launcher/minecraft.jar"

        log "Downloading MinecraftLauncher.jar to $MCPATH/bin..."
