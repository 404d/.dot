...
Key(name="volume up", action="exec pactl set-sink-volume @DEFAULT_SINK@ +5%")
Key(name="volume down", action="exec pactl set-sink-volume @DEFAULT_SINK@ -5%")
Key(name="volume mute", action="exec pactl set-sink-mute @DEFAULT_SINK@ toggle")
