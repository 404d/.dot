...
ZSH_THEME_GIT_PROMPT_PREFIX="%{$bg[031]$fg[117]%}  "
ZSH_THEME_GIT_PROMPT_SUFFIX="%{$bg[031]$fg[117]%}"
ZSH_THEME_GIT_PROMPT_SEPARATOR="%{$bg[031]$fg[117]%}"
ZSH_THEME_GIT_PROMPT_BRANCH="%{$bg[031]$fg[117]%} "
ZSH_THEME_GIT_PROMPT_STAGED="%{$bg[031]$fg[117]%}  ●"
ZSH_THEME_GIT_PROMPT_CONFLICTS="%{$bg[031]$fg[117]%}  ✖ "
ZSH_THEME_GIT_PROMPT_CHANGED="%{$bg[031]$fg[117]%}  ✚ "
ZSH_THEME_GIT_PROMPT_REMOTE="%{$bg[031]$fg[117]%} "
ZSH_THEME_GIT_PROMPT_UNTRACKED="%{$bg[031]$fg[117]%}  ···"
ZSH_THEME_GIT_PROMPT_CLEAN="%{$bg[031]$fg[117]%}"
